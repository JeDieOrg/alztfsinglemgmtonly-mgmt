...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "jens.diedrich@hh-software.com"
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "identity-tf-mgmt-only-single1"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "connectivity-tf-mgmt-only-single1"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "management-tf-mgmt-only-single1"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "security-tf-mgmt-only-single1"
    }
  }
